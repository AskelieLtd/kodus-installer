...
| [0006](0006-rabbitmq-disk-free-limit-relative-false-alarm-high-ram.md) | RabbitMQ blocks all publishing with generic "timeout" on high-RAM hosts | High | Investigating | 2026-07-28 | `MessageBrokerService - Error publishing message to RabbitMQ` (`timeout`); `check_alarms` shows a free-disk alarm despite ample free space |
